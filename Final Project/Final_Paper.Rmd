...
### Finding:1. Is GPA/Race/Gender/LQBTQ/College Generation Status/Financial Status/STEM major/Year in College a greatest factor that affect students' depression? 
...
Thus, it can be concluded that students who are LGBTQ groups is the greatest factor that affect students' depression. 


### Finding:2. Which kind of students would tend to be depressed? 
```{r}
set.seed(1234)
...
logistic <- train(depression ~ ., data = train1, method = "glm", 
